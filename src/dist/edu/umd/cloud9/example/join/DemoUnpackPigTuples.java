 ...
 */
public class DemoUnpackPigTuples {
  private static final Logger sLogger = Logger.getLogger(DemoUnpackPigTuples.class);

  private DemoUnpackPigTuples() {
  }
  /**
   * Runs the demo.
   */
  public static void main(String[] args) throws IOException {
    ...
    for(FileStatus file : inputFiles) {
      ...
      while(reader.next(key, value)) {
        line = ((Tuple)key).toDelimitedString("\t");
        data.write(line + "\n");
        cnt++;
      }
